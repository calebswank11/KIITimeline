...
var bar_color = "transparent"; // the progress bar color
var bar_background = "transparent"; // the color of the empty part of bar
var bar_border = "transparent";  // the color of the bar border
var window_background = "transparent"; // the color of the pop-up window
var window_border = "transparent"; // the border color of pop-up window
...
function setup_bar()
{
	...
	document.write('<div id="bar_window" style="position: fixed;'
		+ ';" onClick="close_bar()">');
...
/////////////////////////////////////////////////
	...
	border */
	document.write('<div id="empty_bar"">');
...
// REMOVE ON HOMEPAGE B/C OF BACKGROUND IMAGES AND NOT ACTUAL IMAGES, THROWS ERROR
var queryString = window.location.search;

function doneLoading(){

	if(queryString.length) {
		console.log(queryString + ' query String exists, load interior content');
	} else {
		$('#bar_window').addClass('doneLoading').css({
			'opacity': '0'
		});
